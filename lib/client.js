...
(() => {
  ...
  var SOURCE_NAME = "dsh-chat-enhancements";
  var STYLE_TAG = "dsh-chat-enhancements/style.css";
  var NS = "chatEnhancements";
  var zh = {
    "http.413": "\u6587\u4EF6\u8D85\u8FC7\u5927\u5C0F\u9650\u5236",
    "http.415": "\u6587\u4EF6\u7C7B\u578B\u4E0D\u88AB\u5141\u8BB8",
...
`;
  ...
  async function uploadFile(actx, file, sessionId, t) {
    ...
    const refText = payload.relativePath !== void 0 ? `@${payload.relativePath}` : payload.path;
  ...
  async function attachFiles(actx, files, sessionId, t) {
  ...
  function DragOverlay({ attach, t }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: `dsh-upload-overlay${active ? " active" : ""}`, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-upload-overlay-box", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: t("drag.title") }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-upload-overlay-hint", children: t("drag.desc") })
    ] }) });
  }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      entries.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-upload-dock", children: entries.map(([ref, meta]) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-upload-card", children: [
          meta.previewUrl !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "img",
            {
              src: meta.previewUrl,
              alt: meta.name,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.Tooltip, { label: t("card.remove"), side: "top", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              type: "button",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DragOverlay, { attach, t })
    ] });
  }
  function apply(ctx) {
    injectCss();
      ...
      () => ctx.slots.register(
        {
          ...
          locale: NS,
          inject: (sessionId) => ({
            attach: (files) => attachFiles(ctx.sessions.scope(sessionId), files, sessionId, t)
          })
        },
        PlusMenuButton
      )
